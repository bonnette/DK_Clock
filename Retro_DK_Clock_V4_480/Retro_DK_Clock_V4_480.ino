...
/*    //Test print of Mario X/Y coordinates
    ...
    myGLCD.printNumI(mX, 140, 10, 3);
    myGLCD.printNumI(mY, 140, 30, 3);
    myGLCD.printNumI(b1Y, 140, 50, 3);
    myGLCD.printNumI(b2Y, 140, 70, 3);
*/
    ...
    // Always jump over barrels

    if (((mX >= b1X-10)&&(mX <= b1X+10)) && ((mY >= b1Y - 15) && (mY <=b1Y +15))){
            jumptrigger = true;}
    if (((mX >= b2X-10)&&(mX <= b2X+10)) && ((mY >= b2Y - 15) && (mY <=b2Y +15))){
            jumptrigger = true;}
    if (((mX >= b3X-10)&&(mX <= b3X+10)) && ((mY >= b3Y - 15) && (mY <=b3Y +15))){
            jumptrigger = true;}
    if (((mX >= b4X-10)&&(mX <= b4X+10)) && ((mY >= b4Y - 15) && (mY <=b4Y +15))){
            jumptrigger = true;}           
        ...
        if ((mY >= 220) && (mY <= 233)) {
          ...
          if ((mY >= 168) && (mY <= 180)) {
            ...
            if ((mY >= 112) && (mY <= 124)) {
              ...
              // Bottom Ladder 1 Level 4 ***Larry Always go up to win
...
/*  //Test print out
        ...
        myGLCD.printNumI(b1X, 220, 115,3);
*/
...
void redraw(int x, int y, int d) {
  ...
  if (y < 125) { // Level 4
    ...
    if (x < 143) {            // Sector 0
      ...
      myGLCD.drawBitmap (34, 86, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (68, 86, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (15, 99, 15, 22, Ladder1);
      myGLCD.drawBitmap (15, 116, 15, 22, Ladder1);

    }

  } else if (y < 181 && y > 169) { // Level 3




    if (x >= 31 && x <= 454) { // Sector 1

      myGLCD.drawBitmap (204, 144, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (238, 145, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (272, 146, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (306, 147, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (340, 148, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (374, 149, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (408, 150, 34, 17, DK_scaffold);


      myGLCD.drawBitmap (151, 159, 15, 22, Ladder1);
      myGLCD.drawBitmap (151, 180, 15, 22, Ladder1);
      myGLCD.drawBitmap (419, 173, 15, 22, Ladder1);
      myGLCD.drawBitmap (419, 167, 15, 22, Ladder1);


    }

  } else if (y <= 233 && y > 221) { // Level 2

    if (x < 102) {             // Sector 4

      myGLCD.drawBitmap (102, 204, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (68, 205, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (34, 206, 34, 17, DK_scaffold);


      myGLCD.drawBitmap (49, 223, 15, 22, Ladder1);

    }

    if (x >= 102 && x <= 360) { // Sector 6

      myGLCD.drawBitmap (102, 204, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (136, 203, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (170, 202, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (204, 201, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (238, 200, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (272, 199, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (306, 198, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (340, 197, 34, 17, DK_scaffold);


      myGLCD.drawBitmap (287, 214, 15, 22, Ladder1);
      myGLCD.drawBitmap (287, 233, 15, 22, Ladder1);
    }

  } else if (y > 247) { // Level 1

    if (x < 56) {             // Sector 8

      myGLCD.drawBitmap (68, 248, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (34, 247, 34, 17, DK_scaffold);
    }
    if (x >= 56 && x <= 132) { // Sector 9

      myGLCD.drawBitmap (68, 248, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (102, 249, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (136, 250, 34, 17, DK_scaffold);


    }
    if (x >= 132 && x <= 212) { // Sector 10

      myGLCD.drawBitmap (102, 249, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (136, 250, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (170, 251, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (204, 252, 34, 17, DK_scaffold);

    }
    if (x >= 212 && x <= 315) { // Sector 11


      myGLCD.drawBitmap (204, 252, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (238, 253, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (272, 254, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (306, 255, 34, 17, DK_scaffold);

    }
    if (x >= 315) { // Sector 12

      myGLCD.drawBitmap (306, 255, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (340, 256, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (374, 257, 34, 17, DK_scaffold);
      myGLCD.drawBitmap (408, 258, 34, 17, DK_scaffold);

      myGLCD.drawBitmap (419, 275, 15, 22, Ladder1);
    }
